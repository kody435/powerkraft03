      ...
      >
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          <div className="sm:col-span-2">
            ...
            <div className="relative mt-2.5 text-black">
              ...
              <input
                ...
                required
                type="text"
                className="block w-full rounded-md border-0 px-3.5 py-2 pl-32 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-100 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm"
              />
            </div>
          </div>
          <div>
